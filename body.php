                        ...
                        echo "
								...
								<div class='product'>
									<a href='product.php?p=$pro_id'><div class='product-img'>
										<img src='product_images/$pro_image' style='max-height: 190px;' alt=''>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price RWF<del class='product-old-price'>00.00</del></h4>
										...
										<div class='product-btns'>
											<button class='add-to-wishlist'><i class='fa fa-heart-o'>256</i><span class='tooltipp'>add to wishlist</span></button>
											<button class='quick-view'><i class='fa fa-eye'>3,561</i><span class='tooltipp'>quick view</span></button>
										</div>
									</div>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">980RWF <del class="product-old-price">0RWF</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
